...
import com.alphaStore.Core.contracts.AESUtilContract
import java.io.*
...
object AESUtil : AESUtilContract {
    @Throws(
    ...
    override fun encrypt(algorithm: String?, input: String, key: SecretKey?, iv: IvParameterSpec?): String {
    ...
    override fun decrypt(algorithm: String?, cipherText: String?, key: SecretKey?, iv: IvParameterSpec?): String {
        val cipher = Cipher.getInstance(algorithm)
    ...
    override fun generateKey(n: Int): SecretKey {
    ...
    override fun getKeyFromPassword(password: String, salt: String): SecretKey {
    ...
    override fun generateIv(): IvParameterSpec {
    ...
    override fun encryptPasswordBased(plainText: String, key: SecretKey?, iv: IvParameterSpec?): String {
    ...
    override fun decryptPasswordBased(cipherText: String?, key: SecretKey?, iv: IvParameterSpec?): String {
        val cipher = Cipher.getInstance("AES/CBC/PKCS5PADDING")
        cipher.init(Cipher.DECRYPT_MODE, key, iv)
        return String(
            cipher.doFinal(
